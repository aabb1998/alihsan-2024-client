...
export const AllProjectsModalComponent = () => {
    ...
    return (
        <div>
                    ...
                    <div className="container">
                        ...
                        <div className="pb-5 md:pb-7.5">
                            <div className="pt-5 md:pt-7.5 flex items-center justify-between form-group whitespace-nowrap">
                                <div className="flex gap-1 md:hidden text-neutral-800 cursor-pointer">
                                <FilterIcon />
                                Filter
                                </div>
                                <div className="hidden md:block">
                        ...
                        {/* <div className="pb-7.5 text-neutral-600">Try checking for spelling errors or try another search term.</div> */}
                        <div className="grid gap-x-5 gap-5 md:gap-y-7.5 sm:grid-cols-2 md:grid-cols-4">
                            ...
                            <div className="transition-all ease-in border bg-neutral-100 rounded-xl border-neutral-300 hover:border-neutral-100 focus:border-primary-300 hover:shadow-card">
                                <div className="flex flex-col gap-5 p-5">
            ...
            <div className="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                ...
                <div className="fixed inset-0 z-10 w-screen overflow-y-auto bg-neutral-1000/60">
                    <div className="flex items-end justify-center min-h-full text-center sm:items-center sm:p-0 max-h-[80vh]">
                        <div className="relative grid w-full  md:grid-cols-2 gap-4 overflow-hidden text-left transition-all transform sm:max-w-[816px]">
                            <div className="overflow-hidden bg-white rounded-t-3xl sm:rounded-3xl">
                                <div className="flex flex-col">
                                    <div className="h-[232px] overflow-hidden">
                                        <img src="/images/banner/projects/1.jpg" alt="" className="object-cover w-full h-full" />
                                    </div>
                                    <div className="p-6">
                                        <h2 className="mb-2 text-heading-6">Sample Header Goes Here</h2>
                                        <p className="text-lg font-medium text-neutral-600">Al-Ihsan Foundation International Limited (formed in 2014) is a non-profit public relief organisation dedicated to assisting all people and families in need. The Arabic word Al-Ihsan means “perfection” or “excellence.” </p>
                                    </div>
                                </div>
                            </div>
                            <div className="py-7.5 bg-white flex px-4 sm:px-6 sm:py-6 rounded-t-3xl sm:rounded-3xl">
                                <div className="flex flex-col gap-5 sm:gap-8 grow">
                                    <div className="flex justify-between">
                                        <div className="font-bold tracking-tighter text-md sm:text-heading-7">Choose Donation</div>
                                    ...
                                    <div className="flex flex-col justify-between grow">
                                        <div className="modal-body">
                                            <label htmlFor="SelectProject" className="block mb-2 text-sm">Project Name</label>
                                            <div className="mb-5 md:mb-4 form-group">
                                                <select className="w-full text-sm !text-neutral-800 form-control" id="SelectProject">
                                                    <option value="">Select Project</option>
                                                </select>
                                            </div>
                                            <div className="flex flex-col gap-5 md:gap-8 ">
                                                <div className="p-2 rounded-lg gap-3.5 flex bg-accent-100">
                                                    <button className="btn-tab btn-primary filled text-button-md">One-time</button>
                                                    <button className="btn-tab btn-secondary-text filled text-button-md hover:bg-transparent">Recurring</button>
                                                </div>
                                                <fieldset className="grid justify-between grid-cols-2 gap-4 md:grid-cols-4">
                                                ...
                                                {/* <div className="flex flex-col form-group">
                                                    <label htmlFor="OtherAmount" className="sr-only">Other Amount</label>
                                                    <input type="text" className="w-full form-control" id="OtherAmount" placeholder="1000" />
                                                </div> */}
                                            </div>
                                        </div>
                        ...
                        <div className="relative w-full overflow-hidden text-left transition-all transform bg-white rounded-t-3xl sm:rounded-3xl sm:max-w-modal">
                            <div className="bg-white py-7.5 px-4 sm:px-7.5 sm:py-10">
                                <div className="flex flex-col gap-8">
                                    <div className="flex justify-between">
                                        <div className="font-bold tracking-tighter text-heading-7">Choose Donation</div>
                                        <button className="transition-colors ease-in-out text-neutral-1000 opacity-90 hover:text-neutral-800">
                                            <CloseIcon iconSize={24} />
                                        </button>
                                    </div>
