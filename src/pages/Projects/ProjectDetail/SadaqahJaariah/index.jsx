...
export const SadaqahJaariahProjectDetails = () => {
  ...
  return (
    <div>
      ...
      {/* Project Details */}
      <main className="py-7.5 md:py-15">
        <section>
          <div className="container">
            <BannerImageComponent bannerImage="14.jpg" />
              ...
              <div className="col-span-7">
                ...
                <div className="flex flex-col gap-5 md:gap-10">
                  <div className="rounded-2.5xl overflow-hidden">
                    <Img
                      src={"/images/banner/projects/5.jpg"}
                      alt=""
                  ...
                  <div className="rounded-2.5xl overflow-hidden">
                    <Img
                      src={"/images/banner/projects/6.jpg"}
                      alt=""
                      className="rounded-2.5xl object-cover min-h-45 w-full h-full"
                    />
                  </div>
