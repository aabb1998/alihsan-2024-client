...
import { RelatedCampaignsHotMeals } from '../Common/RelatedCampaigns';
...
export const HotMealsProjectDetails = () => {
            ...
            <main className="py-7.5 md:py-15 bg-accent-100 sm:bg-neutral-200 bg-[url(images/background/pattern-big.svg)] bg-no-repeat bg-contain sm:bg-auto bg-ramadan-logo-sm sm:bg-ramadan-logo">
                <section>
                    <div className="container">
                        <BannerImageComponent bannerImage="19.jpg" />
                        <div className="grid-cols-12 gap-10 md:grid">
                            <div className="col-span-12 md:col-span-7">
                                <h1 className="mb-6 md:mb-10 text-heading-6 md:text-heading-2">Hot Meals</h1>
                                ...
                                <div className="flex flex-col gap-10">
                                    <div className="rounded-2.5xl overflow-hidden">
                                        <Img src={"/images/banner/projects/6.jpg"} alt="" className="rounded-2.5xl w-full" />
                                    </div>
                                </div>
                                <ShareProject />
                                {/* Updates Tab */}
