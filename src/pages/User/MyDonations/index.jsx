...
import { ChevronDownIcon, CloseIcon, EyeIcon, GlobeIcon, MenuIcon, SearchIcon, ShoppingCartIcon, UserIcon } from '../../../theme/svg-icons'
                        ...
                        <div className="w-full">
                            <div className="md:border border-neutral-300 md:px-10 md:py-7.5 rounded-1.5xl">
                                <div className="border-b mb-5 md:mb-7.5 border-b-neutral-300">
                                    <h1 className="text-heading-6 md:text-heading-5 pb-3.5">My Donations - Recurring</h1>
                                </div>
                                <div className="flex flex-col gap-7.5 justify-center items-center bg-neutral-200 rounded-xl py-10">
                                    <div>
                                        <img src="/images/illustration/no-payments.svg" alt="" />
                                    </div>
                                    <div className="max-w-sm text-sm text-center text-neutral-600">
                                        <h2 className="heading-6 text-neutral-1000">No Payment Yet</h2>
                                        <p>No payment has been made. Please select a project and donate.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-7.5 md:py-15">
                <div className="container">
                    <div className="flex gap-[60px]">
                        ...
                        <div className="w-full">
                            <div className="md:border border-neutral-300 md:px-10 md:py-7.5 rounded-1.5xl">
                                <div className="border-b mb-5 md:mb-7.5 border-b-neutral-300 pb-3.5">
                                    <h1 className="text-heading-6 md:text-heading-5">My Donations</h1>
                                </div>
                                <div className="flex flex-col items-center justify-center gap-5 py-10 bg-neutral-200 rounded-xl">
                                    <div>
                                        <Img src={"/images/illustration/no-donations.svg"} alt="No donation" />
                                    </div>
                                    <div className="max-w-[19rem] text-sm text-center text-neutral-600">
                                        <h2 className="mb-2 heading-6 text-neutral-1000">No Donations Yet</h2>
                                        <p>No donation has been made. Please select a project and donate.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
