...
const ProjectDetailsContent = ({ mydonation, isOpen }) => {
      ...
      >
        <div className="flex flex-col gap-4 sm:gap-5">
          <div className="flex flex-col gap-4 sm:gap-5 max-h-[calc(100vh-16rem)] overflow-auto">
            <div className="mt-5 md:mt-7.5 pt-5">
              <Img
                src={
            ...
            <div className="flex flex-col gap-4 sm:gap-5">
              <div>
                ...
                <p
									className="text-sm font-medium text-neutral-800 line-clamp-3"
									dangerouslySetInnerHTML={{__html: mydonation?.Campaign?.description}}
								/>
              </div>
              <div className="flex-wrap justify-start p-2 rounded-lg sm:flex gap-y-4 gap-x-4 sm:gap-6 bg-neutral-200">
                <div className="flex gap-2 mb-3 grow basis-0 sm:mb-0">
                ...
                {mydonation?.nextPaymentOn && (
                  <div className="flex gap-2 mt-3 grow basis-0 sm:mt-0">
                    <div className="flex items-center justify-center w-10 h-10 p-2 text-green-500 bg-green-300 rounded">
                      <CalendarIcon iconSize={24} />
                    </div>
                    <div className="flex flex-col gap-1">
