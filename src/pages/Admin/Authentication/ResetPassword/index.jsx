...
export const AdminResetPasswordComponent = () => {
    ...
    return (
        <div className='flex flex-col items-center justify-center w-full h-screen px-3 m-auto sm:px-0 max-w-25'>
            ...
            <h1 className="mb-10 text-center text-heading-5 md:text-heading-4 text-neutral-900">Reset Your Password</h1>
            <form className='w-full'>
                ...
                <Button className="w-full btn btn-primary" variant="" type="submit" label={'Reset Password'} />
            </form>
        </div>
    )
