...
export const AddSubscriptionsModal = () => {
    return(
                    ...
                    <div className="bg-white px-4 pt-4 pb-7.5 sm:px-10 sm:pt-10 sm:pb-10 py-10">
                        <div className="flex flex-col gap-5 sm:gap-8">
                            <div className="flex justify-between">
                                <div className="font-bold tracking-tighter text-md sm:text-heading-7">Add Subscriptions</div>
                                <button className="text-neutral-1000">
                                ...
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="relative">
                                          <input type="number" className="w-full !pr-10 form-control" id="Weight" placeholder="MM/DD/YYYY" />
                            ...
                            <div className="flex gap-5 sm:gap-7.5">
                                <button className="flex-grow basis-0 btn btn-outline-secondary">Cancel</button>
                                <button className="flex-grow basis-0 btn btn-primary">Add Subscription</button>
                            </div>
                        </div>
                    </div>
                </div>
