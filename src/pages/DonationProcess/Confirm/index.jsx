...
import { ChevronDownIcon, CloseIcon, GlobeIcon, MenuIcon, SearchIcon, ShoppingCartIcon, UserIcon } from '../../../theme/svg-icons'
                ...
                <div className="container">
                    <div className="grid grid-cols-12">
                        ...
                        <div className="col-span-10">
                            <div className="border border-neutral-300 px-10 py-5 rounded-1.5xl">
                                <div className="border-b mb-7.5 border-b-neutral-300 flex justify-between">
                                    <h1 className="heading-5 pb-3.5">Payment details</h1>
                                    <div>
