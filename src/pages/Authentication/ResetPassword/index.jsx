        ...
        <div className="flex justify-center min-h-screen gap-4 px-4 py-4 md:px-6 lg:justify-normal">
          <div className="flex items-center justify-center md:w-8/12">
            <div className="w-full sm:w-[30.625rem]">
              ...
              <h1 className="mb-5 text-center text-heading-5 md:text-heading-4 text-neutral-900">
                Reset your password
              </h1>
              <form
              ...
              >
                <p className="mb-10 text-sm font-medium text-center text-neutral-600">
                  {" "}
                  Enter the email address that you wish to reset the password
                  for and we'll send you an email with the instructions.
                </p>
