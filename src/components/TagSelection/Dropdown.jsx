...
const Dropdown = ({ list, addItem }) => {
    return (<div id="dropdown" className="absolute z-10 w-full bg-white border rounded border-neutral-200 shadow-card top-12">
        <div className="flex flex-col w-full p-3 overflow-auto max-h-40">
            {list.map((item, key) => {
                return <div key={key}
