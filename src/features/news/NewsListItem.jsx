...
export const NewsListItem = ({ item }) => {
  ...
  return (
    <div className="col-span-1 duration-700 ease-in-out rounded-xl shadow-card ">
      <div className="relative w-full overflow-hidden transition-all ease-in rounded-xl bg-neutral-100">
        ...
        <div className="px-5 pt-4.5 pb-5">
          ...
          <p className="mb-5 text-sm line-clamp-3 text-neutral-600 break-words min-h-[3.75rem]">
            {item.content}
          </p>
          <Link
