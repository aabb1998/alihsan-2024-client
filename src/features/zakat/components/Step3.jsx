...
export default function Step3 () {
  ...
  const { investmentProfit, shareResale, merchandise } = useSelector(state => state.zakatCalculator.amounts)
  ...
  return (
    <div className="flex flex-col gap-5 sm:gap-10">
      <div className="form-group">
        ...
        {errors.investmentProfit && <div className="mt-1 text-sm text-red-300">{errors.investmentProfit}</div>}
        ...
        {errors.shareResale && <div className="mt-1 text-sm text-red-300">{errors.shareResale}</div>}
        ...
        {errors.merchandise && <div className="mt-1 text-sm text-red-300">{errors.merchandise}</div>}
      </div>
      <div className="flex gap-3">
        <Button variant={"secondary"} label={"Back"} onClick={() => dispatch(zakatStep(-1))} />
        <Button variant={"primary"} label={"Next"} onClick={() => dispatch(zakatStep(1))} disabled={errors.investmentProfit || errors.shareResale || errors.merchandise} />
      </div>
    </div>
  );
};
