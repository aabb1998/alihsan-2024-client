...
const costPerMeal = 40;

const RamadanEidGifts = ({ campaign, handleClose, isModal }) => {
  ...
  const findOption = (option) => {
    ...
    if (option === "1") {
      ...
      finalOption = "5 Children";
    } else if (option === "10") {
      finalOption = "10 Children";
    } else if (option === "20") {
      finalOption = "20 Children";
    }
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="flex flex-col gap-5 md:gap-8">
          ...
          <p className="px-4 py-3 font-bold text-sm text-neutral-800 rounded-lg bg-neutral-200">
            {`For widows, orphans, displaced communities, and those trapped in poverty, Eid often arrives with a sense of despair, leaving them feeling isolated and without support. Provide an eid gift to a child for $${costPerMeal}.`}
          </p>
...
export default RamadanEidGifts;

RamadanEidGifts.propTypes = {
  isModal: PropTypes.bool,
};

RamadanEidGifts.defaultProps = {
  handleClose: () => null,
  isModal: false,
};
