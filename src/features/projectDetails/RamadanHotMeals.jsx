...
const costPerMeal = 10;

const RamadanHotMeals = ({ campaign, handleClose, isModal }) => {
  ...
  const findOption = (option) => {
    let finalOption;
    if (option === "1") {
      finalOption = "1 Hot Meal";
    } else if (option === "5") {
      finalOption = "5 Hot Meals";
    } else if (option === "10") {
      finalOption = "10 Hot Meals";
    } else if (option === "20") {
      finalOption = "20 Hot Meals";
    }
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="flex flex-col gap-5 md:gap-8">
          ...
          <p className="px-4 py-3 font-bold text-sm text-neutral-800 rounded-lg bg-neutral-200">
            {`Be a part of our mission to go beyond simply providing meals; we are building meaningful connections with those who need it most. Provide a hot meal for $${costPerMeal}.`}
          </p>
          <div className="my-7.5">
            ...
            <div className="flex items-baseline justify-between gap-4 my-5">
              <div className="grow">Total Meals</div>
...
export default RamadanHotMeals;

RamadanHotMeals.propTypes = {
  isModal: PropTypes.bool,
};

RamadanHotMeals.defaultProps = {
  handleClose: () => null,
  isModal: false,
};
